...
- Added to `schoolnewsfeed.js`: in order to design the news article better with css, three more class-names were introduced: newsfeed-desc, newsfeed-desc, newsfeed-desc
...
- Made homework.js respect config.timeFormat irrespective of locale setting.
...
- Added ability to remove tags from the beginning or end of newsfeed items in 'schoolnewsfeed.js'.
