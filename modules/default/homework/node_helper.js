...
const CalendarFetcher = require("./homeworkfetcher.js");
const Log = require("logger");
const Homeworkfetcher = require("./homeworkfetcher");
...
module.exports = NodeHelper.create({
	...
	createFetcher: function (url, fetchInterval, excludedEvents, maximumEntries, maximumNumberOfDays, auth, broadcastPastEvents, selfSignedCert, identifier) {
		...
		if (typeof this.fetchers[identifier + url] === "undefined") {
			...
			fetcher = new Homeworkfetcher(url, fetchInterval, excludedEvents, maximumEntries, maximumNumberOfDays, auth, broadcastPastEvents, selfSignedCert);
