 ...
 * MIT Licensed.
 */
const CalendarUtils = require("./homeworkutils");
 ...
 * @class
 */
const Homeworkfetcher = function (url, reloadInterval, excludedEvents, maximumEntries, maximumNumberOfDays, auth, includePastEvents, selfSignedCert) {
...
module.exports = Homeworkfetcher;
