...
const NewsfeedFetcher = require("./schoolnewsfeedfetcher.js");
const Log = require("logger");
const Schoolnewsfeedfetcher = require("./schoolnewsfeedfetcher");
...
module.exports = NodeHelper.create({
	...
	createFetcher: function (feed, config) {
		...
		if (typeof this.fetchers[url] === "undefined") {
			...
			fetcher = new Schoolnewsfeedfetcher(url, reloadInterval, encoding, config.logFeedWarnings);
