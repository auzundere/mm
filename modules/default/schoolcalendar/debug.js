...
const url = "file://testCal.ics"; // Standard test URL
...
const fetcher = new Homeworkfetcher(url, fetchInterval, [], maximumEntries, maximumNumberOfDays, auth);
