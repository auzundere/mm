...
const CalendarFetcher = require("./schoolcalendarfetcher.js");
const Log = require("logger");
const Schoolcalendarfetcher = require("./schoolcalendarfetcher");
...
module.exports = NodeHelper.create({
	...
	createFetcher: function (url, fetchInterval, excludedEvents, maximumEntries, maximumNumberOfDays, auth, broadcastPastEvents, selfSignedCert, identifier) {
		...
		if (typeof this.fetchers[identifier + url] === "undefined") {
			...
			fetcher = new Schoolcalendarfetcher(url, fetchInterval, excludedEvents, maximumEntries, maximumNumberOfDays, auth, broadcastPastEvents, selfSignedCert);
