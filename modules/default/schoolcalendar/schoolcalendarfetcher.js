/* MagicMirror²
 * Node Helper: Calendar - Homeworkfetcher
 *
 * By Michael Teeuw https://michaelteeuw.nl
 * MIT Licensed.
 */
const CalendarUtils = require("./schoolcalendarutils");
 ...
 * @class
 */
const Schoolcalendarfetcher = function (url, reloadInterval, excludedEvents, maximumEntries, maximumNumberOfDays, auth, includePastEvents, selfSignedCert) {
	...
	const fetchCalendar = () => {
		...
		try {
			events = require('../../../school_holiday.json');
...
module.exports = Schoolcalendarfetcher;
